...
def update_questions_for_yyyymmdd(logger, y, m, d)
  Dir.chdir(y.to_s) do
    question_str = '../get-tbandroid-creator-answers-questions-for-arbitrary-time-period.rb '
...
def update_answers_for_yyyymmdd(logger, y, m, d)
  Dir.chdir(y.to_s) do
    answer_str = '../get-tbandroid-answers-from-questions-file-for-arbitrary-time-period.rb '
